...
      {isMobileOpen && <div className="fixed inset-0 bg-black bg-opacity-30 z-40 lg:hidden" onClick={() => setIsMobileOpen(false)} />}
...
            <button className="text-gray-600 lg:hidden" onClick={() => setIsMobileOpen(s => !s)}><Menu className="h-5 w-5" /></button>
